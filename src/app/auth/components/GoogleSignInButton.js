...
const GoogleSignInButton = ({
  ...
  return (
    <button
      onClick={onClick}
      className={`w-full mt-4 flex items-center justify-center ${bgColor} ${textColor} py-2 rounded ${hoverColor} transition duration-300 ease-in-out shadow-md focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2`}
...
GoogleSignInButton.propTypes = {
  ...
  text: PropTypes.string, // Button text (default: "Sign In with Google")
